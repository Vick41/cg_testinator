module.exports = {
    '@tags': ['mars','portal','tools','globalClose','smoke'],
    'MARS Portal Tools: Global Close Site Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'Global Close Site\')]')
            .waitForElementVisible('//table[@id=\'MainContent_tblGlobalUpdate\']/tbody/tr/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_tblGlobalUpdate\']/tbody/tr/td','Global Close Site')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
