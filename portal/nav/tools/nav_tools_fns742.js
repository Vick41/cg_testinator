module.exports = {
    '@tags': ['mars','portal','tools','fns742','smoke'],
    'MARS Portal Tools: FNS742 Nav Test':function(browser) {
        ...
        //login
            ...
            .verify.visible('//a[contains(text(),\'User Management\')]','User Management')
        ...
        //main test
            .click('//a[contains(text(),\'FNS-742\')]')
            .acceptAlert()
            .waitForElementVisible('//span[@id=\'MainContent_vc1_lblNameNum\']',5000,false)
            .verify.containsText('//span[@id=\'MainContent_vc1_lblNameNum\']','10001781 TEST4809')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
