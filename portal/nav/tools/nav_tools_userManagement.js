module.exports = {
    '@tags': ['mars','portal','tools','userManagement','smoke'],
    'MARS Portal Tools: User Management Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'User Management\')]')
            .waitForElementVisible('//div[@id=\'MainContent_uPanelUserInfo\']/table/tbody/tr/td',5000,false)
            .verify.containsText('//div[@id=\'MainContent_uPanelUserInfo\']/table/tbody/tr/td','Current User Information')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
