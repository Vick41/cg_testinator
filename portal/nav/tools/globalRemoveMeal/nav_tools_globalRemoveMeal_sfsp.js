module.exports = {
    '@tags': ['mars','portal','tools','globalRemove','sfsp','smoke'],
    'MARS Portal Tools: Global Remove Meal: SFSP Nav Test':function(browser) {
        ...
        //login
            ...
            .verify.hidden('//ul[@id=\'Menu1:submenu:50\']/li/a','CA sub-menu is NOT visible')
            .verify.hidden('//ul[@id=\'Menu1:submenu:50\']/li[2]/a','FCC sub-menu is NOT visible')
            .verify.hidden('//ul[@id=\'Menu1:submenu:50\']/li[3]/a','SFSP sub-menu is NOT visible')
            .verify.hidden('//ul[@id=\'Menu1:submenu:50\']/li[4]/a','SM sub-menu is NOT visible')

            //verify sub-menu items appear when mousing over the top level menu-item
            .moveToElement('//ul[@id=\'Menu1:submenu:42\']/li[3]/a',0,0)
            .verify.visible('//ul[@id=\'Menu1:submenu:50\']/li/a','CA sub-menu IS visible')
            .verify.visible('//ul[@id=\'Menu1:submenu:50\']/li[2]/a','FCC sub-menu IS visible')
            .verify.visible('//ul[@id=\'Menu1:submenu:50\']/li[3]/a','SFSP sub-menu IS visible')
            .verify.visible('//ul[@id=\'Menu1:submenu:50\']/li[4]/a','SM sub-menu IS visible')

            //verify sub-menu items are correctly labelled
            .verify.containsText('//ul[@id=\'Menu1:submenu:50\']/li/a','CA')
            .verify.containsText('//ul[@id=\'Menu1:submenu:50\']/li[2]/a','FCC')
            .verify.containsText('//ul[@id=\'Menu1:submenu:50\']/li[3]/a','SFSP')
            .verify.containsText('//ul[@id=\'Menu1:submenu:50\']/li[4]/a','SM')

        //main test
            .click('//ul[@id=\'Menu1:submenu:50\']/li[3]/a')
            .waitForElementVisible('//table[@id=\'MainContent_tblGlobalUpdate\']/tbody/tr/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_tblGlobalUpdate\']/tbody/tr/td','Global Site Application Meal Removal')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
