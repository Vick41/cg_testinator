module.exports = {
    '@tags': ['mars','portal','tools','ndl','smoke'],
    'MARS Portal Tools: NDL Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'NDL\')]')
            .waitForElementVisible('//table[@id=\'MainContent_Table1\']/tbody/tr/td[5]/table/tbody/tr/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_Table1\']/tbody/tr/td[5]/table/tbody/tr/td','NDL Search')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
