module.exports = {
    '@tags': ['mars','portal','tools','oct13','smoke'],
    'MARS Portal Tools: Oct 13 Data Collection Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'October31st.aspx\')]')
            .waitForElementVisible('//a[@id=\'MainContent_lbtnSiteDetailReport\']',5000,false)
            .verify.containsText('//a[@id=\'MainContent_lbtnSiteDetailReport\']','October 31 Site Level Detail Report')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
