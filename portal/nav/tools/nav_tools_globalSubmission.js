module.exports = {
    '@tags': ['mars','portal','tools','globalSubmission','smoke'],
    'MARS Portal Tools: Global Submission Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'Global Submission\')]')
            .waitForElementVisible('//table[@id=\'MainContent_tblGlobalSubmit\']/tbody/tr/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_tblGlobalSubmit\']/tbody/tr/td','Global Site Application Submission')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
