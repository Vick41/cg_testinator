module.exports = {
    '@tags': ['mars','portal','tools','directCert','smoke'],
    'MARS Portal Tools: Direct Certification Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'Direct Certification\')]')
            .waitForElementVisible('//table[@id=\'MainContent_Table1\']/tbody/tr/td[5]/table/tbody/tr/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_Table1\']/tbody/tr/td[5]/table/tbody/tr/td','Direct Certification')
            .verify.title('Direct Certification')
            .end();
    }
};
