module.exports = {
    '@tags': ['mars','portal','tools','streamlineDataEntry','sfsp','smoke'],
    'MARS Portal Tools: Streamline Data Entry: SFSP Nav Test':function(browser) {
        ...
        //main test
            .click('//ul[@id=\'Menu1:submenu:57\']/li[3]/a')
