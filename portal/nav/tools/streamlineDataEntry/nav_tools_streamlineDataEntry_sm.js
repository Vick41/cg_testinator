module.exports = {
    '@tags': ['mars','portal','tools','streamlineDataEntry','sm','smoke'],
    'MARS Portal Tools: Streamline Data Entry: SM Nav Test':function(browser) {
        ...
        //main test
            .click('//ul[@id=\'Menu1:submenu:57\']/li[4]/a')
