module.exports = {
    '@tags': ['mars','portal','financialManagement','claim','ca','smoke'],
    'MARS Portal Financial Management: Enter Site Claim Data: CA Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'SiteClaim.aspx?Domain=CA&SiteId=\')]')
