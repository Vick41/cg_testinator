module.exports = {
    '@tags': ['mars','portal','financialManagement','claim','sfsp','smoke'],
    'MARS Portal Financial Management: Enter Site Claim Data: SFSP Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'FM/SiteClaim.aspx?Domain=SFSP&SiteId=\')]')
