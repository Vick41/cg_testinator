module.exports = {
    '@tags': ['mars','portal','financialManagement','claim','mk','smoke'],
    'MARS Portal Financial Management: Enter Site Claim Data: MK Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'FM/SiteClaim.aspx?Domain=MK&SiteId=\')]')
