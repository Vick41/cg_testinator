module.exports = {
    '@tags': ['mars','portal','financialManagement','claim','fcc','smoke'],
    'MARS Portal Financial Management: Enter Site Claim Data: FCC Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'FM/SiteClaim.aspx?Domain=FCC&SiteId=\')]')
