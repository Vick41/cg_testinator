module.exports = {
    '@tags': ['mars','portal','quicklinks','programAdmin','agencyProfile','smoke'],
    'MARS Portal Quicklinks: Program Administration: Agency Profile':function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlPAAgency\']')
            .waitForElementVisible('//table[@id=\'MainContent_AgencyList_gvAgency\']/tbody/tr/th',5000,false)
            .verify.containsText('//table[@id=\'MainContent_AgencyList_gvAgency\']/tbody/tr/th','Agency Profile')
            .end();
    }
};
