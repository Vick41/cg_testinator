module.exports = {
    '@tags': ['mars','portal','quicklinks','programAdmin','programProfile','smoke'],
    'MARS Portal Quicklinks: Program Administration: Program Profile' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlPADomain\']')
            .waitForElementVisible('//table[@id=\'MainContent_DomainList_gvDomainList\']/tbody/tr/th[3]',5000,false)
            .verify.containsText('//table[@id=\'MainContent_DomainList_gvDomainList\']/tbody/tr/th[3]','Program')
            .end();
    }
};
