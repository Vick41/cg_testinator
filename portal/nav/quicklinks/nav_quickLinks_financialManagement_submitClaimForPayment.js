module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','submitClaimforPayment','smoke'],
    'MARS Portal Quicklinks: Financial Management: Submit Claim for Payment' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlPSC\']')
            .waitForElementVisible('//div[@id=\'MainContent_pnlSponsorClaim\']/table/tbody/tr/td',5000,false)
            .verify.containsText('//div[@id=\'MainContent_pnlSponsorClaim\']/table/tbody/tr/td','Agency Claim')
            .end();
    }
};
