module.exports = {
    '@tags': ['mars','portal','quicklinks','programAdmin','siteProfile','smoke'],
    'MARS Portal Quicklinks: Program Administration: Site Profile' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlPASite\']')
