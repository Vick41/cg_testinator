module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','specialMilkDairyCost','smoke'],
    'MARS Portal Quicklinks: Financial Management: Special Milk Dairy Cost' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlSMDC\']')
            .waitForElementVisible('//span[@id=\'MainContent_lbTitle\']',5000,false)
            .verify.containsText('//span[@id=\'MainContent_lbTitle\']','Special Milk Dairy Cost')
            .end();
    }
};
