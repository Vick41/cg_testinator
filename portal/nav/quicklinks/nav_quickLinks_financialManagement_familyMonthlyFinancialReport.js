module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','familyMonthlyFinancialReport','smoke'],
    'MARS Portal Quicklinks: Financial Management: Family Monthly Financial Report' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlFCAE\']')
            .waitForElementVisible('//span[@id=\'MainContent_lbTitle\']',5000,false)
            .verify.containsText('//span[@id=\'MainContent_lbTitle\']','Family - Monthly Financial Report')
            .end();
    }
};
