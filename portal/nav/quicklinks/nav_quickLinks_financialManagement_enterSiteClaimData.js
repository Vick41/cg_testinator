module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','enterSiteClaimData','smoke'],
    'MARS Portal Quicklinks: Financial Management: Enter Site Claim Data' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlSC\']')
