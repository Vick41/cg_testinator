module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','specialMilkMonthlyFinancialCost','smoke'],
    'MARS Portal Quicklinks: Financial Management: Special Milk Monthly Financial Cost' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlFRDM\']')
            .waitForElementVisible('//span[@id=\'MainContent_lbTitle\']',5000,false)
            .verify.containsText('//span[@id=\'MainContent_lbTitle\']','Special Milk - Monthly Financial Report')
            .end();
    }
};
