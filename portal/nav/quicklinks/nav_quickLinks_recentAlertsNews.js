module.exports = {
    '@tags': ['mars','portal','quicklinks','financialManagement','recentAlertsNews','smoke'],
    'MARS Portal Quicklinks: Financial Management: Recent Alerts/News' :function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_lnkShortMessageHistory\']')
            .waitForElementVisible('//form[@id=\'Form1\']/div[3]/div[4]/table/tbody/tr/td/table/tbody/tr/td[2]/h2',5000,false)
            .verify.containsText('//form[@id=\'Form1\']/div[3]/div[4]/table/tbody/tr/td/table/tbody/tr/td[2]/h2','Short Message History')
            .end();
    }
};
