module.exports = {
    '@tags': ['mars','portal','quicklinks','programAdmin','workInProgress','smoke'],
    'MARS Portal Quicklinks: Program Administration: Work in Progress':function(browser) {
        ...
        //main test
            .click('//a[@id=\'MainContent_QuickLink_hlPAWorkInProcess\']')
            .waitForElementVisible('//div[@id=\'MainContent_TankList_Panel1\']/table/tbody/tr/td[2]',5000,false)
            .verify.containsText('//a[@id=\'MainContent_QuickLink_hlPAWorkInProcess\']','Work in Progress')
            .end();
    }
};
