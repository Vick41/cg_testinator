module.exports = {
    '@tags': ['mars','portal','programAdmin','cepApp','smoke'],
    'MARS Portal Program Administration: CEP Application Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'FM/CEPApplication.aspx\')]')
            .acceptAlert()
            .waitForElementVisible('//div[@id=\'MainContent_updatePanelMain\']/div/div/h2',5000,false)
            .verify.containsText('//div[@id=\'MainContent_updatePanelMain\']/div/div/h2','Community Eligibility Provision (CEP Application)')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
