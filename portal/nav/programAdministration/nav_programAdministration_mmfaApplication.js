module.exports = {
    '@tags': ['mars','portal','programAdmin','mmfaApp','smoke'],
    'MARS Portal Program Administration: MMFA Application Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'MMFA Application\')]')
            .acceptAlert()
            .waitForElementVisible('//form[@id=\'Form1\']/div[3]/div[4]/table/tbody/tr/td/div/div/h2/strong',5000,false)
            .verify.containsText('//form[@id=\'Form1\']/div[3]/div[4]/table/tbody/tr/td/div/div/h2/strong','MMFA Application')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
