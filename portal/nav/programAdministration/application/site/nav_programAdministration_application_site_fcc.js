module.exports = {
    '@tags': ['mars','portal','programAdmin','site','fcc','smoke'],
    'MARS Portal Program Administration: Application: Site: FCC Nav Test':function(browser) {
