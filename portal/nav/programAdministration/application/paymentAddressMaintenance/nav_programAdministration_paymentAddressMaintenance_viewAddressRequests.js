module.exports = {
    '@tags': ['mars','portal','programAdmin','paymentAddressMaint','viewRequests','smoke'],
    'MARS Portal Program Administration: Payment Address Maintenance: View Address Requests Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'View Address Requests\')]')
            ...
            .verify.title('View Pending Payment Address Requests')
            .end();
    }
};
