module.exports = {
    '@tags': ['mars','portal','programAdmin','paymentAddressMaint','update','smoke'],
    'MARS Portal Program Administration: Payment Address Maintenance: Update Address Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'Update Address\')]')
            ...
            .verify.title('Update Payment Address')
            .end();
    }
};
