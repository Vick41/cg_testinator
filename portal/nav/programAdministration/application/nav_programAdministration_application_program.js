module.exports = {
    '@tags': ['mars','portal','programAdmin','program','smoke'],
    'MARS Portal Program Administration: Application: Agency Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(@href, \'AppFormSelectDomain.aspx\')]')
