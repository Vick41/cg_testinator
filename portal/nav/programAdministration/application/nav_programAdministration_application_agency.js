module.exports = {
    '@tags': ['mars','portal','programAdmin','agency','smoke'],
    'MARS Portal Program Administration: Application: Agency Nav Test':function(browser) {
        ...
        //main test
            .click('//ul[@id=\'Menu1:submenu:5\']/li/a')
            .waitForElementVisible('//table[@id=\'MainContent_AgencyList_gvAgency\']/tbody/tr[2]/td',5000,false)
            .verify.containsText('//table[@id=\'MainContent_AgencyList_gvAgency\']/tbody/tr[2]/td','TEST4809')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
