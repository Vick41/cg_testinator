module.exports = {
    '@tags': ['mars','portal','programAdmin','agency','masterProgram','smoke'],
    'MARS Portal Program Administration: Application: Agency: Master Program Nav Test':function(browser) {
        ...
        //main test
            .click('//a[contains(text(),\'Master Agreement\')]')
            .waitForElementVisible('//span[@id=\'MainContent_lblTitle\']',5000,false)
            .verify.containsText('//span[@id=\'MainContent_lblTitle\']','Master Agreement')
            .verify.title('MSDE MARS Portal')
            .end();
    }
};
