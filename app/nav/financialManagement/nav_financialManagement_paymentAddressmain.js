module.exports = {
    '@tags': ['fm','payAddress','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Payment Address Main':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/PaymentAddressMaintenance.aspx\']')
            .waitForElementVisible('//body',5000,false)
            .verify.containsText('//table[@id=\'tblRight\']/tbody/tr[3]/td/div/h3','Payment Address Maintenance List')
            .verify.containsText('//a[@id=\'ui-id-1\']/b','Payment Address Requests')
            .verify.containsText('//a[@id=\'ui-id-2\']/b','Payment Address List')
            .click('//a[@id=\'ui-id-2\']/b')
            .click('//a[@id=\'ui-id-1\']/b')
            .end();
    }
};
