module.exports = {
    '@tags': ['fm','retroClaim','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Retro Claim Revision':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/RetroClaimRevision.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_pnlMain"]',5000,false)
            .verify.visible('//*[@id="MainContent_pnlMain"]','Table is present')
            .verify.title('MARS - Retro Claim Revision')
            .end();
    }
};
