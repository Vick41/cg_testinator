module.exports = {
    '@tags': ['fm','schedPay','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Scheduled Payment':function(browser) {
