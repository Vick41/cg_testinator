module.exports = {
    '@tags': ['fm','p2','mars','app','smoke'],
    'MARS Nav Menu - Financial Management P2 Management':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/PA/Provision.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_pnlReports"]',5000,false)
            .verify.visible('//*[@id="MainContent_pnlReports"]','Table is present')
            .verify.title('Provision Management')
            .end();
    }
};
