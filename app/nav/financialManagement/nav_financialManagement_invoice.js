module.exports = {
    '@tags': ['fm','invoice','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Invoice':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/Invoice.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_upanelInvoice"]',5000,false)
            .verify.visible('//*[@id="MainContent_upanelInvoice"]','Table is present')
            .verify.title('MARS - Invoice Management')
            .end();
    }
};
