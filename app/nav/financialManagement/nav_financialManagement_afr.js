module.exports = {
    '@tags': ['fm','afr','mars','app','qa2','smoke'],
    'MARS Nav Menu - Office Manager Workspace':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/AFRReporting.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_upnlAFR"]',5000,false)
            .verify.visible('//*[@id="MainContent_upnlAFR"]','Table is present')
            .verify.title('MARS - AFR Reporting')
            .end();
    }
};
