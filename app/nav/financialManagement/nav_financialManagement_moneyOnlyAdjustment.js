module.exports = {
    '@tags': ['fm','moneyAdjust','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Money Only Adjustment':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/MoneyOnlyAdjustment.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_upanelFund"]',5000,false)
            .verify.visible('//*[@id="MainContent_upanelFund"]','Table is present')
            .verify.title('MARS - Money Only Adjustment')
            .end();
    }
};
