module.exports = {
    '@tags': ['fm','claimInput','mars','app','qa2','smoke'],
    'MARS Nav Menu - Office Manager Workspace':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/ClaimInput.aspx?Claim=Domain&AID=*&Source=CI\']')
            .waitForElementVisible('//div[@id=\'MainContent_upanelAgency\']/table/tbody/tr[2]/td',5000,false)
            .verify.containsText('//div[@id=\'MainContent_upanelAgency\']/table/tbody/tr[2]/td','Agency #:')
            .verify.title('MARS - Claim Input')
            .end();
    }
};
