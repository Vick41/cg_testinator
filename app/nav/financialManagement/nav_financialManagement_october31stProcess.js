module.exports = {
    '@tags': ['fm','oct31','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Oct 31 Process':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/Oct31.aspx\']')
            .waitForElementVisible('//a[@id=\'ui-id-1\']',5000,false)
            .verify.containsText('//a[@id=\'ui-id-1\']','Data')
            .verify.title('October 31 Data Process')
            .end();
    }
};
