module.exports = {
    '@tags': ['fm','agencyCodeCheck','mars','app','qa2','smoke'],
    'MARS Nav Menu - Office Manager Workspace':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/AgencyMailCodeCheck.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_divMailCodeList"]',5000,false)
            .verify.visible('//*[@id="MainContent_divMailCodeList"]','Table is present')
            .end();
    }
};
