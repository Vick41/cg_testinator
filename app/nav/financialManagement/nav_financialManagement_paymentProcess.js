module.exports = {
    '@tags': ['fm','paymentProcess','mars','app','smoke'],
    'MARS Nav Menu - Financial Management Payment Process':function(browser) {
        ...
        //select All Workspace button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/FM/PaymentProcess.aspx\']')
            .waitForElementVisible('//div[@id=\'MainContent_panelBatch\']/table/tbody/tr[2]/td',5000,false)
            .verify.containsText('//div[@id=\'MainContent_panelBatch\']/table/tbody/tr[2]/td','Create New Batch')
            .verify.title('MARS - Payment Process')
            .end();
    }
};
