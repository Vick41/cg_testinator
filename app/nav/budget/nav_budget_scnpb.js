module.exports = {
    '@tags': ['budget','scnpb','mars','app','smoke'],
    'MARS Nav Menu - Budget SCNPB':function(browser) {
        ...
        //main test
            ...
            //select SCNB button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/Budget/Budget.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_pnlBody"]',5000,false)
            .verify.visible('//*[@id="MainContent_pnlBody"]','Table is present')
            .verify.title('MARS - Budget SCNPB')
            .end();
    }
};
