module.exports = {
    ...
    'MARS Nav Menu - Budget HQ':function(browser) {
        ...
        //main test
            ...
            //select HQ Expenditure button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/Budget/HQExpenditure.aspx\']')
            .waitForElementVisible('//*[@id="MainContent_pnlBody"]',5000,false)
            .verify.visible('//*[@id="MainContent_pnlBody"]','Table is present')
            .verify.title('MARS - Budget HQ Expenditure')
            .end();
    }
};
