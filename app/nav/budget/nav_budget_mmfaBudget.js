module.exports = {
    '@tags': ['budget','mmfa','mars','app','smoke'],
    'MARS Nav Menu - Budget MMFA':function(browser) {
        ...
        //main test
            ...
            //select MMFA button and verify table loads on next page
            .click('//a[@href=\'' + nav + '/Budget/MMFA\']')
            .waitForElementVisible('//form[@id=\'frmMMFABudget\']/div/h3',5000,false)
            .verify.containsText('//form[@id=\'frmMMFABudget\']/div/h3','MMFA Budget')
            .verify.containsText('//a[@id=\'ui-id-1\']','Budget Forecast')
            .end();
    }
};
